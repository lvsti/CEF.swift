...
public struct CEFErrorCode: RawRepresentable {
    ...
    public static let certBegin = CEFErrorCode(rawValue: ERR_CERT_COMMON_NAME_INVALID)
    ...
    public static let certEnd = CEFErrorCode(rawValue: ERR_CERT_VALIDITY_TOO_LONG)
