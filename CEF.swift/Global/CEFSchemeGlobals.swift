...
///
public func CEFRegisterSchemeHandlerFactory(scheme: String, domain: String? = nil, factory: CEFSchemeHandlerFactory? = nil) -> Bool {
...
///
public func CEFClearSchemeHandlerFactories() -> Bool {
