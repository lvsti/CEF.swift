...
public protocol NavigationEntryVisitor {
...
public extension NavigationEntryVisitor {
    
    public func visit(entry: NavigationEntry, isCurrent: Bool, index: Int, totalCount: Int) -> Bool {
        return false
    }
