...
public enum OnFileDialogAction {
    case ShowDefault
    case ShowCustom
}

extension OnFileDialogAction: BooleanType {
...
public protocol DialogHandler {
    ...
    func onFileDialog(browser: Browser,
                      mode: FileDialogMode,
                      title: String?,
                      defaultPath: String?,
                      acceptFilters: [String],
                      selectedFilterIndex: Int,
                      callback: FileDialogCallback) -> OnFileDialogAction

}

public extension DialogHandler {
