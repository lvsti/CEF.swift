...
public enum OnBeforePopupAction {
    case Allow
    case Cancel
}

extension OnBeforePopupAction: BooleanType {
    public var boolValue: Bool { return self == .Cancel }
}

public enum OnRunModalAction {
    case RunDefaultLoop
    case RunCustomLoop
}

extension OnRunModalAction: BooleanType {
    public var boolValue: Bool { return self == .RunCustomLoop }
}

public enum OnDoCloseAction {
    case Allow
    case Defer
}

extension OnDoCloseAction: BooleanType {
...
/// indicated.
public protocol LifeSpanHandler {
    ...
    func onBeforePopup(browser: Browser,
                       frame: Frame,
                       targetURL: NSURL?,
                       ...
                       inout windowInfo: WindowInfo,
                       inout client: Client,
                       inout settings: BrowserSettings,
                       inout jsAccess: Bool) -> OnBeforePopupAction
    ...
    func onRunModal(browser: Browser) -> OnRunModalAction
    ...
    /// exist.
    func onDoClose(browser: Browser) -> OnDoCloseAction
...
public extension LifeSpanHandler {
