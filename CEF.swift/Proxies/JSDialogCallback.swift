...
/// requests.
public class JSDialogCallback: Proxy<cef_jsdialog_callback_t> {
    ...
    static func fromCEF(ptr: ObjectPtrType) -> JSDialogCallback? {
        return JSDialogCallback(ptr: ptr)
    }
