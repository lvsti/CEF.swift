...
public class DictionaryValue: Proxy<cef_dictionary_value_t> {
    ...
    /// and vice-versa.
    public func isSameAs(other: DictionaryValue) -> Bool {
        return cefObject.is_same(cefObjectPtr, other.toCEF()) != 0
    }

    /// Returns true if this object and |that| object have an equivalent underlying
    /// value but are not necessarily the same object.
    public func isEqualTo(other: DictionaryValue) -> Bool {
    ...
    public func copy(excludesEmptyChildren: Bool) -> DictionaryValue? {
        let copiedObj = cefObject.copy(cefObjectPtr, excludesEmptyChildren ? 1 : 0)
        return DictionaryValue.fromCEF(copiedObj)
    }
    ...
    public func typeForKey(key: String) -> ValueType {
        let cefKeyPtr = CEFStringPtrCreateFromSwiftString(key)
        defer { CEFStringPtrRelease(cefKeyPtr) }
    ...
    public func binaryForKey(key: String) -> BinaryValue? {
        let cefKeyPtr = CEFStringPtrCreateFromSwiftString(key)
        defer { CEFStringPtrRelease(cefKeyPtr) }
    ...
    /// modify this object.
    public func dictionaryForKey(key: String) -> DictionaryValue? {
        let cefKeyPtr = CEFStringPtrCreateFromSwiftString(key)
        defer { CEFStringPtrRelease(cefKeyPtr) }
    ...
    /// this object.
    public func listForKey(key: String) -> ListValue? {
        let cefKeyPtr = CEFStringPtrCreateFromSwiftString(key)
        defer { CEFStringPtrRelease(cefKeyPtr) }
    ...
    /// this object.
    public func setValue(value: Value, forKey key: String) -> Bool {
        let cefKeyPtr = CEFStringPtrCreateFromSwiftString(key)
        defer { CEFStringPtrRelease(cefKeyPtr) }
    ...
    public func setBinary(value: BinaryValue, forKey key: String) -> Bool {
        let cefKeyPtr = CEFStringPtrCreateFromSwiftString(key)
        defer { CEFStringPtrRelease(cefKeyPtr) }
    ...
    /// Otherwise, ownership will be transferred to this object and the |value|
    /// reference will be invalidated.
    public func setDictionary(value: DictionaryValue, forKey key: String) -> Bool {
        let cefKeyPtr = CEFStringPtrCreateFromSwiftString(key)
        defer { CEFStringPtrRelease(cefKeyPtr) }
    ...
    /// Otherwise, ownership will be transferred to this object and the |value|
    /// reference will be invalidated.
    public func setList(value: ListValue, forKey key: String) -> Bool {
        let cefKeyPtr = CEFStringPtrCreateFromSwiftString(key)
        defer { CEFStringPtrRelease(cefKeyPtr) }
    ...
    static func fromCEF(ptr: ObjectPtrType) -> DictionaryValue? {
        return DictionaryValue(ptr: ptr)
    }
}
