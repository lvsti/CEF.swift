...
public class V8Value: Proxy<cef_v8value_t> {
 
    /// Create a new V8Value object of type undefined.
    public static func createUndefined() -> V8Value? {
        return V8Value.fromCEF(cef_v8value_create_undefined())
    }
    
    /// Create a new V8Value object of type null.
    public static func createNull() -> V8Value? {
        return V8Value.fromCEF(cef_v8value_create_null())
    }
    
    /// Create a new V8Value object of type bool.
    public static func createBool(value: Bool) -> V8Value? {
        return V8Value.fromCEF(cef_v8value_create_bool(value ? 1 : 0))
    }

    /// Create a new V8Value object of type int.
    public static func createInt(value: Int) -> V8Value? {
        return V8Value.fromCEF(cef_v8value_create_int(Int32(value)))
    }

    /// Create a new V8Value object of type unsigned int.
    public static func createUInt(value: UInt) -> V8Value? {
        return V8Value.fromCEF(cef_v8value_create_uint(UInt32(value)))
    }
    
    /// Create a new V8Value object of type double.
    public static func createDouble(value: Double) -> V8Value? {
        return V8Value.fromCEF(cef_v8value_create_double(value))
    }
    
    /// Create a new V8Value object of type Date. This method should only be
    /// called from within the scope of a CefRenderProcessHandler, CefV8Handler or
    /// CefV8Accessor callback, or in combination with calling Enter() and Exit()
    /// on a stored CefV8Context reference.
    public static func createDate(value: NSDate) -> V8Value? {
        let cefTimePtr = CEFTimePtrCreateFromNSDate(value)
        defer { CEFTimePtrRelease(cefTimePtr) }
        return V8Value.fromCEF(cef_v8value_create_date(cefTimePtr))
    }
    
    /// Create a new V8Value object of type string.
    public static func createString(value: String?) -> V8Value? {
        let cefStrPtr = value != nil ? CEFStringPtrCreateFromSwiftString(value!) : nil
        defer { CEFStringPtrRelease(cefStrPtr) }
        return V8Value.fromCEF(cef_v8value_create_string(cefStrPtr))
    }

    /// Create a new V8Value object of type object with optional accessor. This
    /// method should only be called from within the scope of a
    /// CefRenderProcessHandler, CefV8Handler or CefV8Accessor callback, or in
    /// combination with calling Enter() and Exit() on a stored CefV8Context
    /// reference.
    public static func createObject(accessor: V8Accessor? = nil) -> V8Value? {
        let cefAccessorPtr = (accessor != nil) ? accessor!.toCEF() : nil
        return V8Value.fromCEF(cef_v8value_create_object(cefAccessorPtr))
    }
    ...
    public static func createArray(length: Int) -> V8Value? {
        return V8Value.fromCEF(cef_v8value_create_array(Int32(length)))
    }
    
    /// Create a new V8Value object of type function. This method should only be
    /// called from within the scope of a CefRenderProcessHandler, CefV8Handler or
    /// CefV8Accessor callback, or in combination with calling Enter() and Exit()
    /// on a stored CefV8Context reference.
    public static func createFunction(name: String, handler: V8Handler? = nil) -> V8Value? {
        let cefStrPtr = CEFStringPtrCreateFromSwiftString(name)
        defer { CEFStringPtrRelease(cefStrPtr) }
        let cefHandlerPtr = handler != nil ? handler!.toCEF() : nil
        return V8Value.fromCEF(cef_v8value_create_function(cefStrPtr, cefHandlerPtr))
    }
    ...
    /// object.
    public func isSameAs(other: V8Value) -> Bool {
    ...
    public var exception: V8Exception? {
        let cefExc = cefObject.get_exception(cefObjectPtr)
        return V8Exception.fromCEF(cefExc)
    }
    ...
    public func valueForKey(key: String) -> V8Value? {
        let cefKeyPtr = CEFStringPtrCreateFromSwiftString(key)
        defer { CEFStringPtrRelease(cefKeyPtr) }
    ...
    /// Returns the value with the specified identifier on success. Returns NULL
    /// if this method is called incorrectly or an exception is thrown.
    public func valueAtIndex(index: Int) -> V8Value? {
    ...
    /// is thrown. For read-only values this method will return true even though
    /// assignment failed.
    public func setValue(value: V8Value, atIndex index: Int) -> Bool {
    ...
    public var userData: UserData? {
        get {
            ...
            return UserData.fromCEF(cefUserData)
        }
        set {
    ...
    /// to perform global garbage collection. Each V8Value tracks the amount of
    ...
    public var functionHandler: V8Handler? {
        let cefHandler = cefObject.get_function_handler(cefObjectPtr)
        return V8HandlerMarshaller.take(cefHandler)
    }
    ...
    public func executeFunction(object: V8Value?, arguments: [V8Value]) -> V8Value? {
    ...
    /// exception is thrown.
    public func executeFunctionWithContext(context: V8Context, object: V8Value?, arguments: [V8Value]) -> V8Value? {
        let cefV8Obj = object != nil ? object!.toCEF() : nil
        let cefArgs = UnsafeMutablePointer<UnsafeMutablePointer<cef_v8value_t>>.alloc(arguments.count)
        defer { cefArgs.dealloc(arguments.count) }
    ...
    static func fromCEF(ptr: ObjectPtrType) -> V8Value? {
        return V8Value(ptr: ptr)
    }
