...
public class SchemeRegistrar: Proxy<cef_scheme_registrar_t> {
    ...
    static func fromCEF(ptr: ObjectPtrType) -> SchemeRegistrar? {
        return SchemeRegistrar(ptr: ptr)
    }
}
