...
public class ContextMenuParams: Proxy<cef_context_menu_params_t> {
    ...
    /// invoked on.
    public var typeFlags: ContextMenuTypeFlags {
        let cefFlags = cefObject.get_type_flags(cefObjectPtr)
        return ContextMenuTypeFlags.fromCEF(cefFlags)
    }
    ...
    public var mediaType: ContextMenuMediaType {
        let cefType = cefObject.get_media_type(cefObjectPtr)
        return ContextMenuMediaType.fromCEF(cefType)
    }
    
    /// Returns flags representing the actions supported by the media element, if
    /// any, that the context menu was invoked on.
    public var mediaStateFlags: ContextMenuMediaStateFlags {
        let cefFlags = cefObject.get_media_state_flags(cefObjectPtr)
        return ContextMenuMediaStateFlags.fromCEF(cefFlags)
    }
    ...
    /// any, that the context menu was invoked on.
    public var editStateFlags: ContextMenuEditStateFlags {
        let cefFlags = cefObject.get_edit_state_flags(cefObjectPtr)
        return ContextMenuEditStateFlags.fromCEF(cefFlags)
    }
    ...
    static func fromCEF(ptr: ObjectPtrType) -> ContextMenuParams? {
        return ContextMenuParams(ptr: ptr)
    }
}
