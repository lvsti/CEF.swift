...
public class DOMNode: Proxy<cef_domnode_t> {

    /// Returns the type for this node.
    public var type: DOMNodeType {
        let cefType = cefObject.get_type(cefObjectPtr)
        return DOMNodeType.fromCEF(cefType)
    }
    ...
    /// object.
    public func isSameAs(other: DOMNode) -> Bool {
    ...
    public var document: DOMDocument {
        ...
        return DOMDocument.fromCEF(cefDoc)!
    }
    ...
    public var firstChild: DOMNode? {
        let cefNode = cefObject.get_first_child(cefObjectPtr)
        return DOMNode.fromCEF(cefNode)
    }

    /// Returns the last child node.
    public var lastChild: DOMNode? {
    ...
    static func fromCEF(ptr: ObjectPtrType) -> DOMNode? {
        return DOMNode(ptr: ptr)
    }
}
