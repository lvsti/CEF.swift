...
public class FileDialogCallback: Proxy<cef_file_dialog_callback_t> {
    ...
    static func fromCEF(ptr: ObjectPtrType) -> FileDialogCallback? {
        return FileDialogCallback(ptr: ptr)
    }
