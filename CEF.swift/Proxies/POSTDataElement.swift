...
public class POSTDataElement: Proxy<cef_post_data_element_t> {
    ...
    public var type: POSTDataElementType {
        let cefType = cefObject.get_type(cefObjectPtr)
        return POSTDataElementType.fromCEF(cefType)
    }
    ...
    static func fromCEF(ptr: ObjectPtrType) -> POSTDataElement? {
        return POSTDataElement(ptr: ptr)
    }
}
