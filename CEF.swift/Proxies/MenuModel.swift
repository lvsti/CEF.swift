...
public class MenuModel: Proxy<cef_menu_model_t> {

    public typealias CommandID = MenuID
    ...
    ///
    public func addSubmenu(label: String, withCommandID commandID: CommandID) -> MenuModel? {
        let cefStrPtr = CEFStringPtrCreateFromSwiftString(label)
        defer { CEFStringPtrRelease(cefStrPtr) }
        let cefMenu = cefObject.add_sub_menu(cefObjectPtr, commandID.toCEF(), cefStrPtr)
        return MenuModel.fromCEF(cefMenu)
    }
    ...
    // is returned.
    ///
    public func insertSubmenu(label: String, atIndex index: Int32, withCommandID commandID: CommandID) -> MenuModel? {
        let cefStrPtr = CEFStringPtrCreateFromSwiftString(label)
        defer { CEFStringPtrRelease(cefStrPtr) }
    ...
    public func typeForCommandID(commandID: CommandID) -> MenuItemType {
        let cefType = cefObject.get_type(cefObjectPtr, commandID.toCEF())
        return MenuItemType.fromCEF(cefType)
    }

    /// Returns the item type at the specified |index|.
    public func typeAtIndex(index: Int32) -> MenuItemType {
    ...
    public func submenuForCommandID(commandID: CommandID) -> MenuModel? {
        let cefMenu = cefObject.get_sub_menu(cefObjectPtr, commandID.toCEF())
        return MenuModel.fromCEF(cefMenu)
    }

    /// Returns the submenu at the specified |index| or empty if invalid.
    public func submenuAtIndex(index: Int32) -> MenuModel? {
    ...
    ///
    public func setAccelerator(accelerator: MenuItemAccelerator, forCommandID commandID: CommandID) -> Bool {
    ...
    ///
    public func setAccelerator(accelerator: MenuItemAccelerator, atIndex index: Int32) -> Bool {
    ...
    // true on success.
    ///
    public func acceleratorForCommandID(commandID: CommandID) -> MenuItemAccelerator? {
        var keyCode: Int32 = 0
        var shift: Int32 = 0
        var control: Int32 = 0
        var alt: Int32 = 0
        ...
        return MenuItemAccelerator(keyCode: keyCode,
                                   shift: shift != 0,
                                   control: control != 0,
                                   alt: alt != 0)
    }
    ...
    // on success.
    ///
    public func acceleratorAtIndex(index: Int32) -> MenuItemAccelerator? {
        var keyCode: Int32 = 0
        var shift: Int32 = 0
        var control: Int32 = 0
        var alt: Int32 = 0
    ...
    static func fromCEF(ptr: ObjectPtrType) -> MenuModel? {
        return MenuModel(ptr: ptr)
    }
}
