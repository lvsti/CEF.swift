...
public class SSLCertPrincipal: Proxy<cef_sslcert_principal_t> {
    ...
    static func fromCEF(ptr: ObjectPtrType) -> SSLCertPrincipal? {
        return SSLCertPrincipal(ptr: ptr)
    }
