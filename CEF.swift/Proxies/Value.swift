...
/// process and thread.
public class Value: Proxy<cef_value_t> {
    ...
    /// and vice-versa.
    public func isSameAs(other: Value) -> Bool {
    ...
    public func copy() -> Value? {
        ...
        return Value.fromCEF(copiedObj)
    }
    ...
    /// to SetBinary().
    public var binaryValue: BinaryValue? {
    ...
    /// object to the SetValue() method instead of passing the returned reference
    /// to SetDictionary().
    public var dictionaryValue: DictionaryValue? {
    ...
    /// object to the SetValue() method instead of passing the returned reference
    /// to SetList().
    public var listValue: ListValue? {
    ...
    public func setBinary(value: BinaryValue) -> Bool {
    ...
    /// successfully. This object keeps a reference to |value| and ownership of the
    /// underlying data remains unchanged.
    public func setDictionary(value: DictionaryValue) -> Bool {
    ...
    /// successfully. This object keeps a reference to |value| and ownership of the
    /// underlying data remains unchanged.
    public func setList(value: ListValue) -> Bool {
    ...
    static func fromCEF(ptr: ObjectPtrType) -> Value? {
