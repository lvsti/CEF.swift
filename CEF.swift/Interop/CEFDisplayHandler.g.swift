...
extension cef_display_handler_t: CEFCallbackMarshalling {
    mutating func marshalCallbacks() {
        on_address_change = CEFDisplayHandler_onAddressChange
        on_title_change = CEFDisplayHandler_onTitleChange
        on_favicon_urlchange = CEFDisplayHandler_onFaviconURLChange
        on_tooltip = CEFDisplayHandler_onTooltip
        on_status_message = CEFDisplayHandler_onStatusMessage
        on_console_message = CEFDisplayHandler_onConsoleMessage
    }
}
