...
extension cef_render_process_handler_t: CEFCallbackMarshalling {
    mutating func marshalCallbacks() {
        on_render_thread_created = CEFRenderProcessHandler_onRenderThreadCreated
        on_web_kit_initialized = CEFRenderProcessHandler_onWebKitInitialized
        on_browser_created = CEFRenderProcessHandler_onBrowserCreated
        on_browser_destroyed = CEFRenderProcessHandler_onBrowserDestroyed
        get_load_handler = CEFRenderProcessHandler_getLoadHandler
        on_before_navigation = CEFRenderProcessHandler_onBeforeNavigation
        on_context_created = CEFRenderProcessHandler_onContextCreated
        on_context_released = CEFRenderProcessHandler_onContextReleased
        on_uncaught_exception = CEFRenderProcessHandler_onUncaughtException
        on_focused_node_changed = CEFRenderProcessHandler_onFocusedNodeChanged
        on_process_message_received = CEFRenderProcessHandler_onProcessMessageReceived
    }
}
